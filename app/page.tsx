...
const RsvpModal = ({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-stone-900/40 backdrop-blur-md transition-opacity animate-in fade-in duration-200 ease-out" onClick={onClose}>
      <div 
        className="relative w-full max-w-sm glass-panel bg-[#fbf9f6]/95 p-8 rounded-[32px] text-center shadow-2xl animate-in slide-in-from-bottom-4 duration-200 ease-out" 
